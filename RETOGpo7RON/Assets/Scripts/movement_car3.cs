...
public class movement_car3 : MonoBehaviour
{
    public int step = 0;
    private float t;
...
/*
    ...
    void Update()
    {
        stop = new Vector3(myVehicleList.Vehicle[5].nextPX, 1, myVehicleList.Vehicle[5].nextPZ);
        endpoint = new Vector3(myVehicleList.Vehicle[5].endPX, 1, myVehicleList.Vehicle[5].endPZ);
