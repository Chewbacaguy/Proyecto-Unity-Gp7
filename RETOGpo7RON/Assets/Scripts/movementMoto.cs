...
public class movementMoto : MonoBehaviour
{
    public int step = 0;
    private float t;
...
/*
    ...
    void Update()
    {
        ...
        stop = new Vector3(myVehicleList.Vehicle[1].nextPX, 1, myVehicleList.Vehicle[1].nextPZ);
        endpoint = new Vector3(myVehicleList.Vehicle[1].endPX, 1, myVehicleList.Vehicle[1].endPZ);
